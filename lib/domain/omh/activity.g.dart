...
KcalUnit _$KcalUnitFromJson(Map<String, dynamic> json) {
  return KcalUnit(json['schema_value']);
}

Map<String, dynamic> _$KcalUnitToJson(KcalUnit instance) {
  var val = <String, dynamic>{};
...
CaloriesBurned _$CaloriesBurnedFromJson(Map<String, dynamic> json) {
  return CaloriesBurned(
    ...
    ..descriptiveStatisticDenominator =
        json['descriptive_statistic_denominator'] == null
            ? null
            : DescriptiveStatisticDenominator.fromJson(
                json['descriptive_statistic_denominator']
