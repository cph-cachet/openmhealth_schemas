...
class TimeFrame extends Object
  ...
  static SchemaId SCHEMA_ID = SchemaId.withVersion(SchemaSupport.OMH_NAMESPACE,
      SchemaSupport.TIME_FRAME, SchemaVersion.V1_0);
...
class TimeInterval extends Object
    ...
    implements SchemaSupport {
  static SchemaId SCHEMA_ID = SchemaId.withVersion(SchemaSupport.OMH_NAMESPACE,
      SchemaSupport.TIME_INTERVAL, SchemaVersion.V1_0);
...
class DurationUnitValue extends UnitValue {
  static SchemaId SCHEMA_ID = SchemaId.withVersion(
      SchemaSupport.OMH_NAMESPACE, 'duration-unit-value', SchemaVersion.V1_0);

  DurationUnitValue(String unit, double value) : super(unit, value);

  factory DurationUnitValue.fromJson(Map<String, dynamic> json) =>
      _$DurationUnitValueFromJson(json);
